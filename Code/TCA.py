...
def TCA_func(classifier,train_data_x, train_data_y, test_data_x, test_data_y):
    tca = TCA(kernel_type='linear', dim=19, lamb=1, gamma=1)
    model = tca.fit_predict(classifier,train_data_x, train_data_y, test_data_x,test_data_y)
